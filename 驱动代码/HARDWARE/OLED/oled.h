...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOD,GPIO_Pin_4)//CLK
...
#define OLED_CS_Clr()  GPIO_ResetBits(GPIOD,GPIO_Pin_0)//CS
#define OLED_CS_Set()  GPIO_SetBits(GPIOD,GPIO_Pin_0)
